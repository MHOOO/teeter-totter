...
goog.net.ChannelRequest.prototype.sendXmlHttp_ = function(a) {
  ...
  this.xmlHttp_ = this.channel_.createXhrIo(this.channel_.shouldUseSecondaryDomains() ? a : null);
  goog.events.listen(this.xmlHttp_, goog.net.EventType.READY_STATE_CHANGE, this.xmlHttpHandler_, !1, this);
...
goog.net.ChannelRequest.prototype.tridentGet_ = function(a) {
  ...
  var b = "", c = "<html><body>";
  a && (b = window.location.hostname, c += '<script>document.domain="' + b + '"<\/script>');
  c += "</body></html>";
  this.trident_.open();
...
goog.net.ChannelRequest.prototype.onTridentDoneAsync_ = function(a) {
  this.cancelled_ || (this.channelDebug_.tridentChannelResponseDone(this.rid_, a), this.cancelWatchDogTimer_(), this.cleanup_(), this.successful_ = a, this.channel_.onRequestComplete(this))
};
...
goog.net.ChannelRequest.prototype.cleanup_ = function() {
  ...
  if(this.xmlHttp_) {
    var a = this.xmlHttp_;
    this.xmlHttp_ = null;
    goog.events.unlisten(a, goog.net.EventType.READY_STATE_CHANGE, this.xmlHttpHandler_, !1, this);
    a.abort()
  }
...
goog.net.BrowserTestChannel.prototype.connectStage2_ = function() {
  ...
  goog.userAgent.IE ? (a.setParameterValues("TYPE", "html"), this.request_.tridentGet(a, Boolean(this.hostPrefix_))) : (a.setParameterValues("TYPE", "xmlhttp"), this.request_.xmlHttpGet(a, !1, this.hostPrefix_, !1))
};
...
goog.net.BrowserTestChannel.prototype.onRequestComplete = function() {
  this.lastStatusCode_ = this.request_.getLastStatusCode();
  if(this.request_.getSuccess()) {
    if(this.state_ == goog.net.BrowserTestChannel.State_.INIT) {
      this.channelDebug_.debug("TestConnection: request complete for initial check"), this.blockedPrefix_ ? (this.state_ = goog.net.BrowserTestChannel.State_.CHECKING_BLOCKED, this.checkBlocked_()) : (this.state_ = goog.net.BrowserTestChannel.State_.CONNECTION_TESTING, this.connectStage2_())
    }else {
      if(this.state_ == goog.net.BrowserTestChannel.State_.CONNECTION_TESTING) {
        ...
        var a = !1;
        (a = goog.userAgent.IE ? 200 > this.lastTime_ - this.firstTime_ ? !1 : !0 : this.receivedIntermediateResult_) ? (this.channelDebug_.debug("Test connection succeeded; using streaming connection"), goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.NOPROXY), this.channel_.testConnectionFinished(this, !0)) : (this.channelDebug_.debug("Test connection failed; not using streaming"), goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.PROXY), this.channel_.testConnectionFinished(this, 
        !1))
      }
    }
  }else {
    this.channelDebug_.debug("TestConnection: request failed, in state " + this.state_), this.state_ == goog.net.BrowserTestChannel.State_.INIT ? goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_ONE_FAILED) : this.state_ == goog.net.BrowserTestChannel.State_.CONNECTION_TESTING && goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_FAILED), this.channel_.testConnectionFailure(this, this.request_.getLastError())
  }
};
...
goog.net.BrowserTestChannel.prototype.isActive = function() {
...
goog.net.BrowserTestChannel.prototype.checkForEarlyNonBuffered_ = function() {
  ...
  return!goog.userAgent.IE || a < goog.net.BrowserTestChannel.MIN_TIME_EXPECTED_BETWEEN_DATA_
};
...
goog.net.BrowserChannel.QueuedMap = function(a, b) {
  this.mapId = a;
  this.map = b
};
...
goog.net.BrowserChannel.prototype.sendMap = function(a) {
  ...
  this.outgoingMaps_.push(new goog.net.BrowserChannel.QueuedMap(this.nextMapId_++, a));
...
goog.net.BrowserChannel.prototype.makeForwardChannelRequest_ = function(a) {
  ...
  b.setExtraHeaders(this.extraHeaders_);
  b.setTimeout(Math.round(0.5 * goog.net.BrowserChannel.FORWARD_CHANNEL_RETRY_TIMEOUT) + Math.round(0.5 * goog.net.BrowserChannel.FORWARD_CHANNEL_RETRY_TIMEOUT * Math.random()));
  this.forwardChannelRequest_ = b;
  b.xmlHttpPost(c, a, !0)
};
...
goog.net.BrowserChannel.prototype.dequeueOutgoingMaps_ = function() {
  ...
  for(var d = 0;d < a;d++) {
    ...
    try {
      goog.structs.forEach(f, function(a, c) {
...
goog.net.BrowserChannel.prototype.startBackChannel_ = function() {
  if(this.okToMakeRequest_()) {
    ...
    goog.userAgent.IE ? (a.setParameterValue("TYPE", "html"), this.backChannelRequest_.tridentGet(a, Boolean(this.hostPrefix_))) : (a.setParameterValue("TYPE", "xmlhttp"), this.backChannelRequest_.xmlHttpGet(a, !0, this.hostPrefix_, !1));
...
goog.net.BrowserChannel.prototype.testConnectionFailure = function(a) {
...
goog.net.BrowserChannel.prototype.onRequestComplete = function(a) {
  ...
  if(this.state_ != goog.net.BrowserChannel.State.CLOSED) {
    if(a.getSuccess()) {
      b == goog.net.BrowserChannel.ChannelType_.FORWARD_CHANNEL ? (b = a.getPostData() ? a.getPostData().length : 0, goog.net.BrowserChannel.notifyTimingEvent(b, goog.now() - a.getRequestStartTime(), this.forwardChannelRetryCount_), this.ensureForwardChannel_(), this.pendingMaps_.length = 0) : this.ensureBackChannel_()
    }else {
...
goog.net.BrowserChannel.prototype.onInput_ = function(a) {
  for(var b = this.handler_ && this.handler_.channelHandleMultipleArrays ? [] : null, c = 0;c < a.length;c++) {
    ...
    d = d[1];
    this.state_ == goog.net.BrowserChannel.State.OPENING ? "c" == d[0] ? (this.sid_ = d[1], this.hostPrefix_ = this.correctHostPrefix(d[2]), d = d[3], this.channelVersion_ = goog.isDefAndNotNull(d) ? d : 6, this.state_ = goog.net.BrowserChannel.State.OPENED, this.handler_ && this.handler_.channelOpened(this), this.backChannelUri_ = this.getBackChannelUri(this.hostPrefix_, this.path_), this.ensureBackChannel_()) : "stop" == d[0] && this.signalError_(goog.net.BrowserChannel.Error.STOP) : this.state_ == 
    goog.net.BrowserChannel.State.OPENED && ("stop" == d[0] ? (b && b.length && (this.handler_.channelHandleMultipleArrays(this, b), b.length = 0), this.signalError_(goog.net.BrowserChannel.Error.STOP)) : "noop" != d[0] && (b ? b.push(d) : this.handler_ && this.handler_.channelHandleArray(this, d)), this.backChannelRetryCount_ = 0)
  }
...
goog.net.BrowserChannel.prototype.createDataUri = function(a, b, c) {
  ...
  this.extraParams_ && goog.structs.forEach(this.extraParams_, function(a, b) {
...
goog.net.BrowserChannel.Handler.prototype.isActive = function() {
  return!0
};
...
de.karolski.teeter_totter.core = {};
de.karolski.teeter_totter.core.jsArr = function jsArr(b) {
...
var log__408841 = goog.debug.Logger.getLogger("DEBUG");
de.karolski.teeter_totter.core.debug = function() {
  var a = function(a) {
    return log__408841.info(cljs.core.reduce.call(null, cljs.core.str, "", a))
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
de.karolski.teeter_totter.core.setup_environment = function() {
  var a = function(a) {
    ...
    return cljs.core.truth_(a) ? b.setCapturing(!0) : null
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
de.karolski.teeter_totter.core._dialog = function(a, b) {
  if(a ? a.de$karolski$teeter_totter$core$AWidgetFactory$_dialog$arity$2 : a) {
    return a.de$karolski$teeter_totter$core$AWidgetFactory$_dialog$arity$2(a, b)
  }
  var c;
  c = de.karolski.teeter_totter.core._dialog[goog.typeOf(null == a ? null : a)];
  if(!c && (c = de.karolski.teeter_totter.core._dialog._, !c)) {
    throw cljs.core.missing_protocol.call(null, "AWidgetFactory.-dialog", a);
  }
  return c.call(null, a, b)
};
de.karolski.teeter_totter.core._button = function(a, b) {
  if(a ? a.de$karolski$teeter_totter$core$AWidgetFactory$_button$arity$2 : a) {
    return a.de$karolski$teeter_totter$core$AWidgetFactory$_button$arity$2(a, b)
  }
  var c;
  c = de.karolski.teeter_totter.core._button[goog.typeOf(null == a ? null : a)];
  if(!c && (c = de.karolski.teeter_totter.core._button._, !c)) {
    throw cljs.core.missing_protocol.call(null, "AWidgetFactory.-button", a);
  }
  return c.call(null, a, b)
};
de.karolski.teeter_totter.core._label = function(a, b) {
  if(a ? a.de$karolski$teeter_totter$core$AWidgetFactory$_label$arity$2 : a) {
    return a.de$karolski$teeter_totter$core$AWidgetFactory$_label$arity$2(a, b)
  }
  var c;
  c = de.karolski.teeter_totter.core._label[goog.typeOf(null == a ? null : a)];
  if(!c && (c = de.karolski.teeter_totter.core._label._, !c)) {
    throw cljs.core.missing_protocol.call(null, "AWidgetFactory.-label", a);
  }
  return c.call(null, a, b)
};
de.karolski.teeter_totter.core._text = function(a, b) {
  if(a ? a.de$karolski$teeter_totter$core$AWidgetFactory$_text$arity$2 : a) {
    return a.de$karolski$teeter_totter$core$AWidgetFactory$_text$arity$2(a, b)
  }
  var c;
  c = de.karolski.teeter_totter.core._text[goog.typeOf(null == a ? null : a)];
  if(!c && (c = de.karolski.teeter_totter.core._text._, !c)) {
    throw cljs.core.missing_protocol.call(null, "AWidgetFactory.-text", a);
  }
  return c.call(null, a, b)
};
de.karolski.teeter_totter.core.APanelFactory = {};
de.karolski.teeter_totter.core._panel = function(a, b) {
  if(a ? a.de$karolski$teeter_totter$core$APanelFactory$_panel$arity$2 : a) {
    return a.de$karolski$teeter_totter$core$APanelFactory$_panel$arity$2(a, b)
  }
  var c;
  c = de.karolski.teeter_totter.core._panel[goog.typeOf(null == a ? null : a)];
  if(!c && (c = de.karolski.teeter_totter.core._panel._, !c)) {
    throw cljs.core.missing_protocol.call(null, "APanelFactory.-panel", a);
  }
  return c.call(null, a, b)
};
...
de.karolski.teeter_totter.core._config = function(a, b) {
  if(a ? a.de$karolski$teeter_totter$core$AConfigurable$_config$arity$2 : a) {
    return a.de$karolski$teeter_totter$core$AConfigurable$_config$arity$2(a, b)
  }
  var c;
  c = de.karolski.teeter_totter.core._config[goog.typeOf(null == a ? null : a)];
  if(!c && (c = de.karolski.teeter_totter.core._config._, !c)) {
    throw cljs.core.missing_protocol.call(null, "AConfigurable.-config", a);
  }
  return c.call(null, a, b)
};
de.karolski.teeter_totter.core._config_BANG_ = function(a, b, c) {
  if(a ? a.de$karolski$teeter_totter$core$AConfigurable$_config_BANG_$arity$3 : a) {
    return a.de$karolski$teeter_totter$core$AConfigurable$_config_BANG_$arity$3(a, b, c)
  }
  var d;
  d = de.karolski.teeter_totter.core._config_BANG_[goog.typeOf(null == a ? null : a)];
  if(!d && (d = de.karolski.teeter_totter.core._config_BANG_._, !d)) {
    throw cljs.core.missing_protocol.call(null, "AConfigurable.-config!", a);
  }
  return d.call(null, a, b, c)
};
de.karolski.teeter_totter.core.AConfigurableMap = {};
de.karolski.teeter_totter.core._config_map = function(a) {
  if(a ? a.de$karolski$teeter_totter$core$AConfigurableMap$_config_map$arity$1 : a) {
    return a.de$karolski$teeter_totter$core$AConfigurableMap$_config_map$arity$1(a)
  }
  var b;
  b = de.karolski.teeter_totter.core._config_map[goog.typeOf(null == a ? null : a)];
  if(!b && (b = de.karolski.teeter_totter.core._config_map._, !b)) {
    throw cljs.core.missing_protocol.call(null, "AConfigurableMap.-config-map", a);
  }
  return b.call(null, a)
};
...
de.karolski.teeter_totter.core.generic_configure_BANG_ = function(a, b) {
  ...
  if(c) {
    ...
    for(cljs.core.nth.call(null, d, 1, null);;) {
      ...
      cljs.core.truth_(d.call(null, de.karolski.teeter_totter.core.config_map.call(null, a))) && (de.karolski.teeter_totter.core.debug.call(null, "Setting ", d, " to ", e, " on ", a), de.karolski.teeter_totter.core.config_BANG_.call(null, a, d, e));
      if(c = cljs.core.next.call(null, c)) {
        d = c, c = cljs.core.first.call(null, d), e = d, d = c, c = e
      }else {
        return null
...
de.karolski.teeter_totter.core.set_framework_BANG_ = function(a) {
  return cljs.core.reset_BANG_.call(null, de.karolski.teeter_totter.core._PLUS_ui_framework_PLUS_, a)
};
de.karolski.teeter_totter.core.framework = function() {
...
de.karolski.teeter_totter.core._bind_event = function(a, b, c, d) {
  if(a ? a.de$karolski$teeter_totter$core$AEventBinder$_bind_event$arity$4 : a) {
    return a.de$karolski$teeter_totter$core$AEventBinder$_bind_event$arity$4(a, b, c, d)
  }
  var e;
  e = de.karolski.teeter_totter.core._bind_event[goog.typeOf(null == a ? null : a)];
  if(!e && (e = de.karolski.teeter_totter.core._bind_event._, !e)) {
    throw cljs.core.missing_protocol.call(null, "AEventBinder.-bind-event", a);
  }
  return e.call(null, a, b, c, d)
};
de.karolski.teeter_totter.core.listen = function() {
  var a = null, b = function() {
    var b = function(b, c) {
      var d = cljs.core.seq.call(null, cljs.core.partition.call(null, 2, c));
      if(d) {
        var e = cljs.core.first.call(null, d);
        cljs.core.nth.call(null, e, 0, null);
        for(cljs.core.nth.call(null, e, 1, null);;) {
          var j = e, e = cljs.core.nth.call(null, j, 0, null), j = cljs.core.nth.call(null, j, 1, null);
          a.call(null, b, e, j);
          if(d = cljs.core.next.call(null, d)) {
            e = d, d = cljs.core.first.call(null, e), j = e, e = d, d = j
          }else {
            return null
          }
        }
    ...
    return de.karolski.teeter_totter.core._bind_event.call(null, de.karolski.teeter_totter.core.framework.call(null), a, b, c)
  }, a = function(a, e, f) {
    var g = f;
    switch(arguments.length) {
      case 1:
        return a;
      default:
        return b.cljs$lang$arity$variadic(a, e, cljs.core.array_seq(arguments, 3));
      case 3:
...
de.karolski.teeter_totter.core._PLUS_linb_widget_opt_map_PLUS_ = cljs.core.ObjMap.EMPTY;
de.karolski.teeter_totter.core._PLUS_linb_button_opt_map_PLUS_ = cljs.core.ObjMap.EMPTY;
linb.UI.Widget.prototype.de$karolski$teeter_totter$core$AConfigurable$ = !0;
linb.UI.Widget.prototype.de$karolski$teeter_totter$core$AConfigurable$_config$arity$2 = function(a, b) {
  return cljs.core.get_in.call(null, de.karolski.teeter_totter.core.config_map.call(null, a), cljs.core.PersistentVector.fromArray([b, 0], !0)).call(null, a)
};
linb.UI.Widget.prototype.de$karolski$teeter_totter$core$AConfigurable$_config_BANG_$arity$3 = function(a, b, c) {
  return cljs.core.get_in.call(null, de.karolski.teeter_totter.core.config_map.call(null, a), cljs.core.PersistentVector.fromArray([b, 1], !0)).call(null, a, c)
};
linb.UI.Button.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
linb.UI.Button.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map$arity$1 = function() {
  return de.karolski.teeter_totter.core._PLUS_linb_button_opt_map_PLUS_
};
linb.UI.Widget.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
linb.UI.Widget.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map$arity$1 = function() {
  return de.karolski.teeter_totter.core._PLUS_linb_widget_opt_map_PLUS_
};
de.karolski.teeter_totter.core.dialog = function() {
  var a = function(a) {
    var a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, b = cljs.core._lookup.call(null, a, "\ufdd0'on-select", null);
    cljs.core._lookup.call(null, a, "\ufdd0'button-set", null);
    cljs.core._lookup.call(null, a, "\ufdd0'title", null);
    cljs.core._lookup.call(null, a, "\ufdd0'content", null);
    var e = de.karolski.teeter_totter.core._dialog.call(null, de.karolski.teeter_totter.core.framework.call(null), cljs.core.ObjMap.EMPTY);
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, e, a);
    cljs.core.truth_(b) && de.karolski.teeter_totter.core.listen.call(null, e, "\ufdd0'select", b);
    return e
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
...
de.karolski.teeter_totter.core.button = function() {
  var a = function(a) {
    ...
    cljs.core._lookup.call(null, a, "\ufdd0'color", null);
    cljs.core._lookup.call(null, a, "\ufdd0'tooltip", null);
    cljs.core._lookup.call(null, a, "\ufdd0'text", "");
    var b = de.karolski.teeter_totter.core._button.call(null, de.karolski.teeter_totter.core.framework.call(null), cljs.core.ObjMap.EMPTY);
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, b, a);
    return b
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
...
de.karolski.teeter_totter.core.text = function() {
  var a = function(a) {
    a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
    cljs.core._lookup.call(null, a, "\ufdd0'text", "");
    var b = de.karolski.teeter_totter.core._text.call(null, de.karolski.teeter_totter.core.framework.call(null), cljs.core.ObjMap.EMPTY);
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, b, a);
    return b
  }, b = function(b) {
    var d = null;
...
de.karolski.teeter_totter.core.label = function() {
  var a = function(a) {
    a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
    cljs.core._lookup.call(null, a, "\ufdd0'text", null);
    var b = de.karolski.teeter_totter.core._label.call(null, de.karolski.teeter_totter.core.framework.call(null), cljs.core.ObjMap.EMPTY);
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, b, a);
    return b
  }, b = function(b) {
    var d = null;
...
de.karolski.teeter_totter.core.panel = function() {
  var a = function(a) {
    a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
    cljs.core._lookup.call(null, a, "\ufdd0'items", null);
    cljs.core._lookup.call(null, a, "\ufdd0'orientation", "\ufdd0'horizontal");
    var b = de.karolski.teeter_totter.core._panel.call(null, de.karolski.teeter_totter.core.framework.call(null), cljs.core.ObjMap.EMPTY);
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, b, a);
    return b
  }, b = function(b) {
    var d = null;
...
goog.events.KeyHandler.prototype.handleEvent = function(a) {
  ...
  d = b.charCode || 0, goog.userAgent.MAC && (d == goog.events.KeyCodes.QUESTION_MARK && !c) && (c = goog.events.KeyCodes.SLASH));
...
goog.ui.MenuItemRenderer.prototype.hasCheckBoxStructure = function(a) {
  if(a = this.getContentElement(a)) {
    ...
    return!!a && !!a.className && -1 != a.className.indexOf(b)
  }
  return!1
};
...
goog.ui.MenuItem.prototype.getCaption = function() {
  var a = this.getContent();
  return goog.isArray(a) ? (a = goog.array.map(a, function(a) {
    return goog.dom.classes.has(a, "goog-menuitem-accel") ? "" : goog.dom.getRawTextContent(a)
  }).join(""), goog.string.collapseBreakingSpaces(a)) : goog.ui.MenuItem.superClass_.getCaption.call(this)
};
...
goog.ui.Menu.prototype.decorateContent = function(a) {
  for(var b = this.getRenderer(), a = this.getDomHelper().getElementsByTagNameAndClass("div", b.getCssClass() + "-content", a), c = a.length, d = 0;d < c;d++) {
...
goog.fx.Dragger.prototype.initializeDrag_ = function(a) {
  !1 !== this.dispatchEvent(new goog.fx.DragEvent(goog.fx.Dragger.EventType.START, this, a.clientX, a.clientY, a)) && (this.dragging_ = !0)
};
...
goog.fx.Dragger.prototype.handleMove_ = function(a) {
  if(this.enabled_) {
    ...
    b = c.x;
    c = c.y;
    this.dragging_ && !1 !== this.dispatchEvent(new goog.fx.DragEvent(goog.fx.Dragger.EventType.BEFOREDRAG, this, a.clientX, a.clientY, a, b, c)) && (this.doDrag(a, b, c, !1), a.preventDefault())
  }
};
...
goog.ui.PopupBase.prototype.onDocumentBlur_ = function(a) {
  if(this.enableCrossIframeDismissal_) {
    ...
    if(goog.userAgent.IE || goog.userAgent.OPERA) {
      if(a = b.activeElement, !a || goog.dom.contains(this.element_, a) || "BODY" == a.tagName) {
        return
      }
    }else {
      if(a.target != b) {
...
goog.ui.ModalPopup.prototype.setVisible = function(a) {
  ...
  a != this.visible_ && (a ? this.show_() : this.hide_())
};
goog.ui.ModalPopup.prototype.show_ = function() {
  this.dispatchEvent(goog.ui.PopupBase.EventType.BEFORE_SHOW) && (this.resizeBackground_(), this.reposition(), this.getHandler().listen(this.getDomHelper().getWindow(), goog.events.EventType.RESIZE, this.resizeBackground_), this.showPopupElement_(!0), this.focus(), this.visible_ = !0, this.dispatchEvent(goog.ui.PopupBase.EventType.SHOW))
};
goog.ui.ModalPopup.prototype.hide_ = function() {
  this.dispatchEvent(goog.ui.PopupBase.EventType.BEFORE_HIDE) && (this.getHandler().unlisten(this.getDomHelper().getWindow(), goog.events.EventType.RESIZE, this.resizeBackground_), this.showPopupElement_(!1), this.visible_ = !1, this.dispatchEvent(goog.ui.PopupBase.EventType.HIDE))
};
...
goog.ui.ModalPopup.prototype.resizeBackground_ = function() {
  ...
  this.bgIframeEl_ && (goog.style.showElement(this.bgIframeEl_, !0), goog.style.setSize(this.bgIframeEl_, b, a));
...
goog.ui.ModalPopup.prototype.onFocus_ = function(a) {
  a.target == this.tabCatcherElement_ && goog.Timer.callOnce(this.focusElement_, 0, this)
};
...
goog.ui.Dialog.prototype.createDom = function() {
  ...
  goog.dom.append(a, this.titleEl_, this.contentEl_ = b.createDom("div", this.class_ + "-content"), this.buttonEl_ = b.createDom("div", this.class_ + "-buttons"));
  this.titleId_ = this.titleEl_.id;
  goog.dom.a11y.setRole(a, "dialog");
  goog.dom.a11y.setState(a, "labelledby", this.titleId_ || "");
...
goog.ui.Dialog.prototype.decorateInternal = function(a) {
  ...
  (this.contentEl_ = goog.dom.getElementsByTagNameAndClass(null, a, this.getElement())[0]) ? this.content_ = this.contentEl_.innerHTML : (this.contentEl_ = this.getDomHelper().createDom("div", a), this.content_ && (this.contentEl_.innerHTML = this.content_), this.getElement().appendChild(this.contentEl_));
  ...
  this.titleCloseEl_ || (this.titleCloseEl_ = this.getDomHelper().createDom("span", c), this.titleEl_.appendChild(this.titleCloseEl_));
  goog.style.showElement(this.titleCloseEl_, this.hasTitleCloseButton_);
...
goog.ui.Dialog.prototype.setVisibleInternal_ = function(a) {
  a.target == this && (this.isVisible() ? (this.getHandler().listen(this.getElement(), goog.events.EventType.KEYDOWN, this.onKey_).listen(this.getElement(), goog.events.EventType.KEYPRESS, this.onKey_), this.dispatchEvent(goog.ui.Dialog.EventType.AFTER_SHOW), this.getHandler().listen(this.buttonEl_, goog.events.EventType.CLICK, this.onButtonClick_)) : (this.getHandler().unlisten(this.getElement(), goog.events.EventType.KEYDOWN, this.onKey_).unlisten(this.getElement(), goog.events.EventType.KEYPRESS, 
  this.onKey_).unlisten(this.buttonEl_, goog.events.EventType.CLICK, this.onButtonClick_), this.dispatchEvent(goog.ui.Dialog.EventType.AFTER_HIDE), this.disposeOnHide_ && this.dispose()))
};
goog.ui.Dialog.prototype.focus = function() {
  ...
  if(this.getButtonSet()) {
    ...
    if(a) {
      for(var b = this.getDomHelper().getDocument(), c = this.buttonEl_.getElementsByTagName("button"), d = 0, e;e = c[d];d++) {
        if(e.name == a) {
          try {
...
goog.ui.Dialog.prototype.setDraggerLimits_ = function() {
  var a = this.getDomHelper().getDocument(), b = goog.dom.getWindow(a) || window, b = goog.dom.getViewportSize(b), c = Math.max(a.body.scrollWidth, b.width), a = Math.max(a.body.scrollHeight, b.height), d = goog.style.getSize(this.getElement());
  "fixed" == goog.style.getComputedPosition(this.getElement()) ? this.dragger_.setLimits(new goog.math.Rect(0, 0, Math.max(0, b.width - d.width), Math.max(0, b.height - d.height))) : this.dragger_.setLimits(new goog.math.Rect(0, 0, c - d.width, a - d.height))
};
...
goog.ui.Dialog.prototype.onKey_ = function(a) {
  ...
  if(a.type == goog.events.EventType.KEYDOWN) {
    if(this.escapeToCancel_ && a.keyCode == goog.events.KeyCodes.ESC) {
      ...
      a.keyCode == goog.events.KeyCodes.TAB && (a.shiftKey && e == this.getElement()) && (c = !0)
    }
  }else {
    if(a.keyCode == goog.events.KeyCodes.ENTER) {
      if("BUTTON" == e.tagName) {
        ...
        if(d) {
          var g = d.getDefault(), h = g && d.getButton(g), e = ("TEXTAREA" == e.tagName || "SELECT" == e.tagName) && !e.disabled;
          h && (!h.disabled && !e) && (f = g)
        }
      }
      f && d && (c = !0, b = this.dispatchEvent(new goog.ui.Dialog.Event(f, "" + d.get(f))))
    }
  }
  if(b || c) {
...
goog.ui.LabelInput.prototype.decorateInternal = function(a) {
  ...
  goog.dom.getActiveElement(goog.dom.getOwnerDocument(a)) == a && (this.hasFocus_ = !0, goog.dom.classes.remove(this.getElement(), this.LABEL_CLASS_NAME));
...
goog.ui.LabelInput.prototype.setLabel = function(a) {
  goog.ui.LabelInput.SUPPORTS_PLACEHOLDER_ ? (this.label_ = a, this.getElement() && (this.getElement().placeholder = this.label_)) : (this.getElement() && !this.hasChanged() && (this.getElement().value = ""), this.label_ = a, this.restoreLabel_(), this.getElement() && goog.dom.a11y.setState(this.getElement(), goog.dom.a11y.State.LABEL, this.label_))
};
...
de.karolski.teeter_totter.frameworks = {};
de.karolski.teeter_totter.frameworks.google = {};
de.karolski.teeter_totter.frameworks.google.Framework = function() {
};
de.karolski.teeter_totter.frameworks.google.Framework.cljs$lang$type = !0;
de.karolski.teeter_totter.frameworks.google.Framework.cljs$lang$ctorPrSeq = function() {
...
de.karolski.teeter_totter.frameworks.google.orientation_kw__GT_google_orientation = function(a) {
...
de.karolski.teeter_totter.frameworks.google.event_kw__GT_google_event = function(a) {
  ...
  "\ufdd0'disable":goog.ui.Component.EventType.DISABLE, "\ufdd0'unselect":goog.ui.Component.EventType.UNSELECT, "\ufdd0'unhighlight":goog.ui.Component.EventType.UNHIGHLIGHT, "\ufdd0'open":goog.ui.Component.EventType.OPEN, "\ufdd0'deactivate":goog.ui.Component.EventType.DEACTIVATE, "\ufdd0'select":goog.ui.Component.EventType.SELECT, "\ufdd0'show":goog.ui.Component.EventType.SHOW, "\ufdd0'activate":goog.ui.Component.EventType.ACTIVATE}).call(null, a)
};
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$APanelFactory$ = !0;
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$APanelFactory$_panel$arity$2 = function() {
  return new goog.ui.Component
};
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$AEventBinder$ = !0;
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$AEventBinder$_bind_event$arity$4 = function(a, b, c, d) {
  return goog.events.listen(b, function() {
    var a = de.karolski.teeter_totter.frameworks.google.event_kw__GT_google_event.call(null, c);
    return cljs.core.truth_(a) ? a : c
  }(), d)
};
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$AWidgetFactory$ = !0;
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$AWidgetFactory$_dialog$arity$2 = function() {
  return new goog.ui.Dialog
};
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$AWidgetFactory$_button$arity$2 = function() {
  return new goog.ui.Button
};
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$AWidgetFactory$_label$arity$2 = function() {
  return new goog.ui.Control
};
de.karolski.teeter_totter.frameworks.google.Framework.prototype.de$karolski$teeter_totter$core$AWidgetFactory$_text$arity$2 = function() {
  return new goog.ui.LabelInput
};
de.karolski.teeter_totter.frameworks.google.set_orientation_on_BANG_ = function(a, b) {
  var c = de.karolski.teeter_totter.core.config.call(null, a, "\ufdd0'items");
  if(cljs.core.truth_(cljs.core.truth_(c) ? cljs.core._EQ_.call(null, b, "\ufdd0'horizontal") : c)) {
    var d = cljs.core.seq.call(null, c);
    if(d) {
      for(c = cljs.core.first.call(null, d);;) {
        if(goog.style.setInlineBlock(c.getElement()), c = cljs.core.next.call(null, d)) {
    ...
    if(d = cljs.core.seq.call(null, c)) {
      for(c = cljs.core.first.call(null, d);;) {
        if(goog.style.setStyle(c.getElement(), "display", "block"), c = cljs.core.next.call(null, d)) {
          d = c, c = cljs.core.first.call(null, d)
        }else {
          return null
        }
...
de.karolski.teeter_totter.frameworks.google._PLUS_component_opt_map_PLUS_ = cljs.core.ObjMap.fromObject(["\ufdd0'listen", "\ufdd0'visible?", "\ufdd0'items", "\ufdd0'orientation"], {"\ufdd0'listen":cljs.core.PersistentVector.fromArray([function() {
  de.karolski.teeter_totter.core.debug.call(null, "NOT IMPLEMENTED!");
  return null
}, function(a, b) {
  return cljs.core.apply.call(null, de.karolski.teeter_totter.core.listen, a, b)
}], !0), "\ufdd0'visible?":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getVisible()
}, function(a, b) {
  return a.setVisible(b)
}], !0), "\ufdd0'items":cljs.core.PersistentVector.fromArray([function(a) {
  return cljs.core.map.call(null, function(b) {
    return a.getChild(b)
  }, a.getChildIds())
}, function(a, b) {
  ...
  if(c) {
    for(var d = cljs.core.first.call(null, c);;) {
      if(a.addChild(d, !0), d = cljs.core.next.call(null, c)) {
        c = d, d = cljs.core.first.call(null, c)
      }else {
        return null
      }
...
}], !0), "\ufdd0'orientation":cljs.core.PersistentVector.fromArray([function() {
  throw Error("Not implemented");
}, function(a, b) {
  return de.karolski.teeter_totter.frameworks.google.set_orientation_on_BANG_.call(null, a, b)
}], !0)});
de.karolski.teeter_totter.frameworks.google._PLUS_control_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.frameworks.google._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'text"], {"\ufdd0'text":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getCaption()
}, function(a, b) {
  return a.setCaption(b)
}], !0)}));
de.karolski.teeter_totter.frameworks.google._PLUS_button_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.frameworks.google._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'text", "\ufdd0'tooltip", "\ufdd0'color", "\ufdd0'button-set"], {"\ufdd0'text":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getContent()
}, function(a, b) {
  return a.setContent(b)
}], !0), "\ufdd0'tooltip":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getTooltip()
}, function(a, b) {
  return a.setTooltip(b)
}], !0), "\ufdd0'color":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getValue()
}, function(a, b) {
  return a.setValue(b)
}], !0), "\ufdd0'button-set":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getButtonSet()
}, function(a, b) {
  return a.setButtonSet(b)
}], !0)}));
de.karolski.teeter_totter.frameworks.google._PLUS_dialog_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.frameworks.google._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'title"], {"\ufdd0'title":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getTitle()
}, function(a, b) {
  return a.setTitle(b)
}], !0)}), cljs.core.ObjMap.fromObject(["\ufdd0'modal?"], {"\ufdd0'modal?":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getModal()
}, function(a, b) {
  return a.setModal(b)
}], !0)}), cljs.core.ObjMap.fromObject(["\ufdd0'content"], {"\ufdd0'content":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getChildAt(0)
}, function(a, b) {
  return a.addChildAt(b, 0, !0)
}], !0)}));
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurable$ = !0;
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurable$_config$arity$2 = function(a, b) {
  return cljs.core.get_in.call(null, de.karolski.teeter_totter.core.config_map.call(null, a), cljs.core.PersistentVector.fromArray([b, 0], !0)).call(null, a)
};
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurable$_config_BANG_$arity$3 = function(a, b, c) {
  return cljs.core.get_in.call(null, de.karolski.teeter_totter.core.config_map.call(null, a), cljs.core.PersistentVector.fromArray([b, 1], !0)).call(null, a, c)
};
goog.ui.Button.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
goog.ui.Button.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map$arity$1 = function() {
  return de.karolski.teeter_totter.frameworks.google._PLUS_button_opt_map_PLUS_
};
goog.ui.Dialog.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
goog.ui.Dialog.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map$arity$1 = function() {
  return de.karolski.teeter_totter.frameworks.google._PLUS_dialog_opt_map_PLUS_
};
goog.ui.Control.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
goog.ui.Control.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map$arity$1 = function() {
  return de.karolski.teeter_totter.frameworks.google._PLUS_control_opt_map_PLUS_
};
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map$arity$1 = function() {
  return de.karolski.teeter_totter.frameworks.google._PLUS_component_opt_map_PLUS_
};
de.karolski.teeter_totter.example = {};
de.karolski.teeter_totter.example.example1 = function() {
  var a = de.karolski.teeter_totter.core.dialog.call(null, "\ufdd0'title", "Hello There2!", "\ufdd0'content", de.karolski.teeter_totter.core.vertical_panel.call(null, "\ufdd0'items", cljs.core.PersistentVector.fromArray([de.karolski.teeter_totter.core.horizontal_panel.call(null, "\ufdd0'items", cljs.core.PersistentVector.fromArray([de.karolski.teeter_totter.core.label.call(null, "\ufdd0'text", "Name"), de.karolski.teeter_totter.core.text.call(null, "\ufdd0'text", "Joe Smith")], !0)), de.karolski.teeter_totter.core.horizontal_panel.call(null, 
  "\ufdd0'items", cljs.core.PersistentVector.fromArray([de.karolski.teeter_totter.core.label.call(null, "\ufdd0'text", "E-Mail"), de.karolski.teeter_totter.core.text.call(null, "\ufdd0'text", "Joe.Smith@template.com")], !0)), de.karolski.teeter_totter.core.horizontal_panel.call(null, "\ufdd0'items", cljs.core.PersistentVector.fromArray([de.karolski.teeter_totter.core.button.call(null, "\ufdd0'text", "Push me!", "\ufdd0'tooltip", "Not implemented", "\ufdd0'color", "green", "\ufdd0'listen", cljs.core.PersistentVector.fromArray(["\ufdd0'action", 
  function() {
    return de.karolski.teeter_totter.core.debug.call(null, "Button clicked!")
  }], !0))], !0))], !0)));
  return de.karolski.teeter_totter.core.config_BANG_.call(null, a, "\ufdd0'visible?", !0)
};
de.karolski.teeter_totter.example.example2 = function() {
  goog.debug.Logger.getLogger("Local").info("Hallo Welt! Ich war hier!");
  return de.karolski.teeter_totter.core.button.call(null, "\ufdd0'text", "Database", "\ufdd0'tooltip", "Database Connection Status", "\ufdd0'color", "red").render(goog.dom.getElement("buttons"))
};
de.karolski.teeter_totter.example.main = function() {
  de.karolski.teeter_totter.core.set_framework_BANG_.call(null, new de.karolski.teeter_totter.frameworks.google.Framework);
  ...
  de.karolski.teeter_totter.example.example1.call(null);
  return de.karolski.teeter_totter.example.example2.call(null)
};
