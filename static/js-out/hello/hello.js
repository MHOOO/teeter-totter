...
goog.ui.ButtonRenderer.prototype.createDom = function(a) {
  ...
  a.isSupportedState(goog.ui.Component.State.CHECKED) && this.updateAriaState(b, goog.ui.Component.State.CHECKED, !1);
  return b
};
...
goog.ui.CustomButtonRenderer.prototype.hasBoxStructure = function(a, b) {
  ...
  return c && c.className.indexOf(this.getCssClass() + "-outer-box") != -1 && (c = a.getDomHelper().getFirstElementChild(c)) && c.className.indexOf(this.getCssClass() + "-inner-box") != -1 ? !0 : !1
};
...
goog.ui.Dialog.prototype.useIframeMask_ = !1;
...
goog.ui.Dialog.prototype.visible_ = !1;
...
goog.ui.Dialog.prototype.manageBackgroundDom_ = function() {
  if(this.useIframeMask_ && this.modal_ && !this.bgIframeEl_) {
    this.bgIframeEl_ = goog.dom.iframe.createBlank(this.getDomHelper()), this.bgIframeEl_.className = this.class_ + "-bg", goog.style.showElement(this.bgIframeEl_, !1), goog.style.setOpacity(this.bgIframeEl_, 0)
  }else {
    if((!this.useIframeMask_ || !this.modal_) && this.bgIframeEl_) {
  ...
  if(this.modal_ && !this.bgEl_) {
    this.bgEl_ = this.getDomHelper().createDom("div", this.class_ + "-bg"), goog.style.setOpacity(this.bgEl_, this.backgroundElementOpacity_), goog.style.showElement(this.bgEl_, !1)
  }else {
    if(!this.modal_ && this.bgEl_) {
...
goog.ui.Dialog.prototype.onKey_ = function(a) {
  ...
  if(a.type == goog.events.EventType.KEYDOWN) {
    ...
    if(a.keyCode == goog.events.KeyCodes.ENTER) {
      ...
      f && (c = !0, b = this.dispatchEvent(new goog.ui.Dialog.Event(f, String(d.get(f)))))
    }
  }
  if(b || c) {
...
goog.ui.LabelInput.prototype.attachEventsToForm_ = function() {
  if(!this.formAttached_ && this.eventHandler_ && this.getElement().form) {
    this.eventHandler_.listen(this.getElement().form, goog.events.EventType.SUBMIT, this.handleFormSubmit_), this.formAttached_ = !0
  }
};
...
goog.net.ChannelRequest.prototype.onXmlHttpReadyStateChanged_ = function() {
  ...
  if(this.successful_) {
    ...
    b == 400 && c.indexOf("Unknown SID") > 0 ? (this.lastError_ = goog.net.ChannelRequest.Error.UNKNOWN_SESSION_ID, goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_UNKNOWN_SESSION_ID)) : (this.lastError_ = goog.net.ChannelRequest.Error.STATUS, goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_BAD_STATUS)), this.channelDebug_.xmlHttpChannelResponseText(this.rid_, c), this.cleanup_(), this.dispatchFailure_()
  }
};
goog.net.ChannelRequest.prototype.decodeNextChunks_ = function(a, b) {
  for(var c = !0;!this.cancelled_ && this.xmlHttpChunkStart_ < b.length;) {
    ...
    if(d == goog.net.ChannelRequest.INCOMPLETE_CHUNK_) {
      if(a == goog.net.XmlHttp.ReadyState.COMPLETE) {
        this.lastError_ = goog.net.ChannelRequest.Error.BAD_DATA, goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_INCOMPLETE_DATA), c = !1
      }
  ...
  if(a == goog.net.XmlHttp.ReadyState.COMPLETE && b.length == 0) {
    this.lastError_ = goog.net.ChannelRequest.Error.NO_DATA, goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_NO_DATA), c = !1
  }
...
goog.net.ChannelRequest.prototype.tridentGet_ = function(a) {
  ...
  var b = "", c = "<html><body>";
  if(a) {
    b = window.location.hostname, c += '<script>document.domain="' + b + '"<\/script>'
  }
  c += "</body></html>";
  this.trident_.open();
...
goog.net.ChannelRequest.prototype.onTridentDoneAsync_ = function(a) {
  if(!this.cancelled_) {
    this.channelDebug_.tridentChannelResponseDone(this.rid_, a), this.cancelWatchDogTimer_(), this.cleanup_(), this.successful_ = a, this.channel_.onRequestComplete(this)
  }
};
...
goog.net.ChannelRequest.prototype.cancelWatchDogTimer_ = function() {
  if(this.watchDogTimerId_) {
    goog.global.clearTimeout(this.watchDogTimerId_), this.watchDogTimerId_ = null
  }
};
goog.net.ChannelRequest.prototype.onWatchDogTimeout_ = function() {
  this.watchDogTimerId_ = null;
  var a = goog.now();
  a - this.watchDogTimeoutTime_ >= 0 ? this.handleTimeout_() : (this.channelDebug_.warning("WatchDog timer called too early"), this.startWatchDogTimer_(this.watchDogTimeoutTime_ - a))
};
...
goog.net.ChannelDebug.prototype.maybeRedactArray_ = function(a) {
  if(!(a.length < 2) && (a = a[1], goog.isArray(a) && !(a.length < 1))) {
    var b = a[0];
    if(b != "c" && b != "noop" && b != "stop") {
...
goog.net.ChannelDebug.prototype.maybeRedactPostData_ = function(a) {
  ...
  for(var b = "", a = a.split("&"), c = 0;c < a.length;c++) {
    var d = a[c].split("=");
    if(d.length > 1) {
      var e = d[0], d = d[1], f = e.split("_");
      b += f.length >= 2 && f[1] == "type" ? e + "=" + d + "&" : e + "=redacted&"
    }
  }
  return b
};
...
goog.net.BrowserTestChannel.ALLOW_EARLY_NON_BUFFERED_DETECTION = !1;
  ...
  if(this.state_ == goog.net.BrowserTestChannel.State_.INIT) {
    ...
    if(this.state_ == goog.net.BrowserTestChannel.State_.CONNECTION_TESTING) {
      if(this.receivedIntermediateResult_) {
        goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_DATA_TWO), this.lastTime_ = goog.now()
      }else {
        if(b == "11111") {
          if(goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_DATA_ONE), this.receivedIntermediateResult_ = !0, this.firstTime_ = goog.now(), this.checkForEarlyNonBuffered_()) {
            this.lastStatusCode_ = 200, this.request_.cancel(), this.channelDebug_.debug("Test connection succeeded; using streaming connection"), goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.NOPROXY), this.channel_.testConnectionFinished(this, !0)
          }
        }else {
          goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_DATA_BOTH), this.firstTime_ = this.lastTime_ = goog.now(), this.receivedIntermediateResult_ = !1
        }
      }
    }
  }
  ...
  if(this.request_.getSuccess()) {
    if(this.state_ == goog.net.BrowserTestChannel.State_.INIT) {
      ...
      if(this.state_ == goog.net.BrowserTestChannel.State_.CONNECTION_TESTING) {
        ...
        var a = !1;
        (a = goog.userAgent.IE ? this.lastTime_ - this.firstTime_ < 200 ? !1 : !0 : this.receivedIntermediateResult_) ? (this.channelDebug_.debug("Test connection succeeded; using streaming connection"), goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.NOPROXY), this.channel_.testConnectionFinished(this, !0)) : (this.channelDebug_.debug("Test connection failed; not using streaming"), goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.PROXY), this.channel_.testConnectionFinished(this, 
        !1))
      }
    }
  }else {
...
goog.net.BrowserTestChannel.prototype.checkForEarlyNonBuffered_ = function() {
  ...
  return(!goog.userAgent.IE || a < goog.net.BrowserTestChannel.MIN_TIME_EXPECTED_BETWEEN_DATA_) && goog.net.BrowserTestChannel.ALLOW_EARLY_NON_BUFFERED_DETECTION
};
...
goog.structs.CircularBuffer.prototype.getLast = function() {
  return this.getCount() == 0 ? null : this.get(this.getCount() - 1)
};
...
goog.net.BrowserChannel.prototype.connect = function(a, b, c, d, e) {
  ...
  this.extraParams_ = c || {};
  if(d && goog.isDef(e)) {
    this.extraParams_.OSID = d, this.extraParams_.OAID = e
  }
  this.connectTest_(a)
};
...
goog.net.BrowserChannel.prototype.cancelRequests_ = function() {
  if(this.connectionTest_) {
    this.connectionTest_.abort(), this.connectionTest_ = null
  }
  if(this.backChannelRequest_) {
    this.backChannelRequest_.cancel(), this.backChannelRequest_ = null
  }
  if(this.backChannelTimerId_) {
    goog.global.clearTimeout(this.backChannelTimerId_), this.backChannelTimerId_ = null
  }
  this.clearDeadBackchannelTimer_();
  if(this.forwardChannelRequest_) {
    this.forwardChannelRequest_.cancel(), this.forwardChannelRequest_ = null
  }
  if(this.forwardChannelTimerId_) {
    goog.global.clearTimeout(this.forwardChannelTimerId_), this.forwardChannelTimerId_ = null
  }
};
...
goog.net.BrowserChannel.prototype.ensureForwardChannel_ = function() {
  if(!this.forwardChannelRequest_ && !this.forwardChannelTimerId_) {
    this.forwardChannelTimerId_ = goog.net.BrowserChannel.setTimeout(goog.bind(this.onStartForwardChannelTimer_, this), 0), this.forwardChannelRetryCount_ = 0
  }
};
...
goog.net.BrowserChannel.prototype.startForwardChannel_ = function(a) {
  ...
  this.state_ == goog.net.BrowserChannel.State.INIT ? a ? this.channelDebug_.severe("Not supposed to retry the open") : (this.open_(), this.state_ = goog.net.BrowserChannel.State.OPENING) : this.state_ == goog.net.BrowserChannel.State.OPENED && this.okToMakeRequest_() && (a ? this.makeForwardChannelRequest_(a) : this.outgoingMaps_.length == 0 ? this.channelDebug_.debug("startForwardChannel_ returned: nothing to send") : this.forwardChannelRequest_ ? this.channelDebug_.severe("startForwardChannel_ returned: connection already in progress") : 
...
goog.net.BrowserChannel.prototype.makeForwardChannelRequest_ = function(a) {
  var b;
  a ? this.channelVersion_ > 6 ? (this.requeuePendingMaps_(), b = this.nextRid_ - 1, a = this.dequeueOutgoingMaps_()) : (b = a.getRequestId(), a = a.getPostData()) : (b = this.nextRid_++, a = this.dequeueOutgoingMaps_());
  ...
  b.setExtraHeaders(this.extraHeaders_);
  b.setTimeout(Math.round(goog.net.BrowserChannel.FORWARD_CHANNEL_RETRY_TIMEOUT * 0.5) + Math.round(goog.net.BrowserChannel.FORWARD_CHANNEL_RETRY_TIMEOUT * 0.5 * Math.random()));
  this.forwardChannelRequest_ = b;
  b.xmlHttpPost(c, a, !0)
};
...
goog.net.BrowserChannel.prototype.dequeueOutgoingMaps_ = function() {
  ...
  this.channelVersion_ > 6 && a > 0 ? (c = this.outgoingMaps_[0].mapId, b.push("ofs=" + c)) : c = 0;
  for(var d = 0;d < a;d++) {
    var e = this.outgoingMaps_[d].mapId, f = this.outgoingMaps_[d].map;
    this.channelVersion_ <= 6 ? e = d : e -= c;
    try {
...
goog.net.BrowserChannel.prototype.ensureBackChannel_ = function() {
  if(!this.backChannelRequest_ && !this.backChannelTimerId_) {
    this.backChannelAttemptId_ = 1, this.backChannelTimerId_ = goog.net.BrowserChannel.setTimeout(goog.bind(this.onStartBackChannelTimer_, this), 0), this.backChannelRetryCount_ = 0
  }
};
  ...
  if(!(this.state_ == goog.net.BrowserChannel.State.CLOSED || this.backChannelRequest_ != a && this.forwardChannelRequest_ != a)) {
    if(this.lastStatusCode_ = a.getLastStatusCode(), this.forwardChannelRequest_ == a && this.state_ == goog.net.BrowserChannel.State.OPENED) {
      if(this.channelVersion_ > 7) {
        ...
        goog.isArray(c) && c.length == 3 ? this.handlePostResponse_(c) : (this.channelDebug_.debug("Bad POST response data returned"), this.signalError_(goog.net.BrowserChannel.Error.BAD_RESPONSE))
      }else {
...
goog.net.BrowserChannel.prototype.handlePostResponse_ = function(a) {
  if(a[0] == 0) {
    ...
    if(0 < b && (a = a[2], this.channelDebug_.debug(a + " bytes (in " + b + " arrays) are outstanding on the BackChannel"), this.shouldRetryBackChannel_(a) && !this.deadBackChannelTimerId_)) {
...
goog.net.BrowserChannel.prototype.shouldRetryBackChannel_ = function(a) {
  return a < goog.net.BrowserChannel.OUTSTANDING_DATA_BACKCHANNEL_RETRY_CUTOFF && !this.isBuffered() && this.backChannelRetryCount_ == 0
};
...
goog.net.BrowserChannel.prototype.onBackChannelDead_ = function() {
  if(goog.isDefAndNotNull(this.deadBackChannelTimerId_)) {
    this.deadBackChannelTimerId_ = null, this.backChannelRequest_.cancel(), this.backChannelRequest_ = null, this.maybeRetryBackChannel_(), goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.BACKCHANNEL_DEAD)
  }
};
goog.net.BrowserChannel.prototype.clearDeadBackchannelTimer_ = function() {
  if(goog.isDefAndNotNull(this.deadBackChannelTimerId_)) {
    goog.global.clearTimeout(this.deadBackChannelTimerId_), this.deadBackChannelTimerId_ = null
  }
};
goog.net.BrowserChannel.isFatalError_ = function(a, b) {
  return a == goog.net.ChannelRequest.Error.UNKNOWN_SESSION_ID || a == goog.net.ChannelRequest.Error.STATUS && b > 0
};
  ...
  if(this.state_ != goog.net.BrowserChannel.State.CLOSED) {
    if(a.getSuccess()) {
      ...
      if(goog.net.BrowserChannel.isFatalError_(c, this.lastStatusCode_)) {
        ...
        if(b == goog.net.BrowserChannel.ChannelType_.FORWARD_CHANNEL && this.maybeRetryForwardChannel_(a)) {
          return
        }
        if(b == goog.net.BrowserChannel.ChannelType_.BACK_CHANNEL && this.maybeRetryBackChannel_()) {
          return
        }
...
goog.net.BrowserChannel.prototype.onInput_ = function(a) {
  for(var b = this.handler_ && this.handler_.channelHandleMultipleArrays ? [] : null, c = 0;c < a.length;c++) {
    ...
    if(this.state_ == goog.net.BrowserChannel.State.OPENING) {
      d[0] == "c" ? (this.sid_ = d[1], this.hostPrefix_ = this.correctHostPrefix(d[2]), d = d[3], this.channelVersion_ = goog.isDefAndNotNull(d) ? d : 6, this.state_ = goog.net.BrowserChannel.State.OPENED, this.handler_ && this.handler_.channelOpened(this), this.backChannelUri_ = this.getBackChannelUri(this.hostPrefix_, this.path_), this.ensureBackChannel_()) : d[0] == "stop" && this.signalError_(goog.net.BrowserChannel.Error.STOP)
    }else {
      if(this.state_ == goog.net.BrowserChannel.State.OPENED) {
        if(d[0] == "stop") {
          if(b && b.length) {
            this.handler_.channelHandleMultipleArrays(this, b), b.length = 0
          }
          this.signalError_(goog.net.BrowserChannel.Error.STOP)
        }else {
          d[0] != "noop" && (b ? b.push(d) : this.handler_ && this.handler_.channelHandleArray(this, d))
        }
...
goog.net.BrowserChannel.prototype.createDataUri = function(a, b, c) {
  var d = window.location, e = goog.Uri.create(d.protocol, null, a ? a + "." + d.hostname : d.hostname, c || d.port, b);
...
cljs.core.select_keys = function(a, b) {
  for(var c = cljs.core.ObjMap.fromObject([], {}), d = cljs.core.seq.call(null, b);;) {
    if(cljs.core.truth_(d)) {
      var e = cljs.core.first.call(null, d), f = cljs.core.get.call(null, a, e, "\ufdd0'de.karolski.teeter-totter.core/not-found"), c = cljs.core.truth_(cljs.core.not_EQ_.call(null, f, "\ufdd0'de.karolski.teeter-totter.core/not-found")) ? cljs.core.assoc.call(null, c, e, f) : c, d = cljs.core.next.call(null, d)
    }else {
      return c
    }
  }
...
de.karolski.teeter_totter.core.jsArr = function jsArr(b) {
  return cljs.core.vec.call(null, cljs.core.map.call(null, function(b) {
    return cljs.core.truth_(cljs.core.sequential_QMARK_.call(null, b)) ? jsArr.call(null, b) : b
  }, b)).array
};
de.karolski.teeter_totter.core.jsObj = function jsObj(b) {
  return cljs.core.into.call(null, cljs.core.ObjMap.fromObject([], {}), cljs.core.map.call(null, function(b) {
    ...
    return cljs.core.truth_(cljs.core.map_QMARK_.call(null, b)) ? cljs.core.Vector.fromArray([d, jsObj.call(null, b)]) : cljs.core.Vector.fromArray([d, b])
  }, b)).strobj
};
var log__21954 = goog.debug.Logger.getLogger.call(null, "DEBUG");
de.karolski.teeter_totter.core.debug = function() {
  var a = function(a) {
    return log__21954.info(cljs.core.reduce.call(null, cljs.core.str, "", a))
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
de.karolski.teeter_totter.core.setup_environment = function() {
  var a = function(a) {
    var a = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, a = cljs.core.get.call(null, a, "\ufdd0'debug?"), b = new goog.debug.Console;
...
de.karolski.teeter_totter.core.setup_connection = function() {
  var a = new goog.net.BrowserChannel(8), b = new goog.net.BrowserChannel.Handler, c = goog.debug.Logger.getLogger.call(null, "setup-connection");
  b.channelOpened = function() {
    return c.info("Channel Opened")
  };
  b.channelClosed = function() {
    return c.info("Channel Closed")
  };
  b.channelError = function(a, b) {
    return c.info("Channel Error:" + b)
  };
  b.channelHandleArray = function(a, b) {
    c.info("Channel Handle Array:" + b);
    return a.sendMap(de.karolski.teeter_totter.core.jsObj.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'result"], {"\ufdd0'result":goog.json.serialize.call(null, eval.call(null, b))})))
  };
  c.info("Connecting to server through BrowserChannel");
  a.setHandler(b);
  return a.connect("channel/test", "channel/channel", de.karolski.teeter_totter.core.jsObj.call(null, cljs.core.ObjMap.fromObject([], {})))
};
...
de.karolski.teeter_totter.core._config = function(a, b) {
  return cljs.core.truth_(cljs.core.truth_(a) ? a.de$karolski$teeter_totter$core$AConfigurable$_config : a) ? a.de$karolski$teeter_totter$core$AConfigurable$_config(a, b) : function() {
    var b = de.karolski.teeter_totter.core._config[goog.typeOf.call(null, a)];
    if(cljs.core.truth_(b)) {
      return b
    }else {
      if(b = de.karolski.teeter_totter.core._config._, cljs.core.truth_(b)) {
        return b
      }else {
...
de.karolski.teeter_totter.core._config_BANG_ = function(a, b, c) {
  return cljs.core.truth_(cljs.core.truth_(a) ? a.de$karolski$teeter_totter$core$AConfigurable$_config_BANG_ : a) ? a.de$karolski$teeter_totter$core$AConfigurable$_config_BANG_(a, b, c) : function() {
    var b = de.karolski.teeter_totter.core._config_BANG_[goog.typeOf.call(null, a)];
    if(cljs.core.truth_(b)) {
      return b
    }else {
      if(b = de.karolski.teeter_totter.core._config_BANG_._, cljs.core.truth_(b)) {
        return b
      }else {
        throw cljs.core.missing_protocol.call(null, "AConfigurable.-config!", a);
      }
...
de.karolski.teeter_totter.core._config_map = function(a) {
  return cljs.core.truth_(cljs.core.truth_(a) ? a.de$karolski$teeter_totter$core$AConfigurableMap$_config_map : a) ? a.de$karolski$teeter_totter$core$AConfigurableMap$_config_map(a) : function() {
    var b = de.karolski.teeter_totter.core._config_map[goog.typeOf.call(null, a)];
    if(cljs.core.truth_(b)) {
      return b
    }else {
      if(b = de.karolski.teeter_totter.core._config_map._, cljs.core.truth_(b)) {
        return b
      }else {
...
de.karolski.teeter_totter.core.event_kw__GT_google_event = function(a) {
  return a.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'hide", "\ufdd0'close", "\ufdd0'action", "\ufdd0'before-show", "\ufdd0'leave", "\ufdd0'highlight", "\ufdd0'uncheck", "\ufdd0'check", "\ufdd0'blur", "\ufdd0'change", "\ufdd0'enter", "\ufdd0'focus", "\ufdd0'enable", "\ufdd0'disable", "\ufdd0'unselect", "\ufdd0'unhighlight", "\ufdd0'open", "\ufdd0'deactivate", "\ufdd0'select", "\ufdd0'show", "\ufdd0'activate"], {"\ufdd0'hide":goog.ui.Component.EventType.HIDE, "\ufdd0'close":goog.ui.Component.EventType.CLOSE, 
  ...
  "\ufdd0'enable":goog.ui.Component.EventType.ENABLE, "\ufdd0'disable":goog.ui.Component.EventType.DISABLE, "\ufdd0'unselect":goog.ui.Component.EventType.UNSELECT, "\ufdd0'unhighlight":goog.ui.Component.EventType.UNHIGHLIGHT, "\ufdd0'open":goog.ui.Component.EventType.OPEN, "\ufdd0'deactivate":goog.ui.Component.EventType.DEACTIVATE, "\ufdd0'select":goog.ui.Component.EventType.SELECT, "\ufdd0'show":goog.ui.Component.EventType.SHOW, "\ufdd0'activate":goog.ui.Component.EventType.ACTIVATE}))
};
  ...
  var a = null, b = function() {
    var b = function(b, c) {
      ...
      if(cljs.core.truth_(d)) {
        ...
        for(cljs.core.nth.call(null, h, 1, null);;) {
          var i = h, h = cljs.core.nth.call(null, i, 0, null), i = cljs.core.nth.call(null, i, 1, null);
          a.call(null, b, h, i);
          d = cljs.core.next.call(null, d);
          if(cljs.core.truth_(d)) {
            h = d, d = cljs.core.first.call(null, h), i = h, h = d, d = i
          }else {
            return null
          }
        }
    ...
    switch(arguments.length) {
      ...
      case 3:
        var g = a;
        goog.events.listen.call(null, g, de.karolski.teeter_totter.core.event_kw__GT_google_event.call(null, d), f);
        return g
    }
    throw"Invalid arity: " + arguments.length;
  };
...
de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_ = cljs.core.ObjMap.fromObject(["\ufdd0'listen", "\ufdd0'visible?", "\ufdd0'items"], {"\ufdd0'listen":cljs.core.Vector.fromArray([function() {
...
}]), "\ufdd0'visible?":cljs.core.Vector.fromArray([function(a) {
  return a.getVisible
}, function(a, b) {
  return a.setVisible(b)
}]), "\ufdd0'items":cljs.core.Vector.fromArray([function() {
  de.karolski.teeter_totter.core.debug.call(null, "NOT IMPLEMENTED!");
  return null
}, function(a, b) {
  var c = cljs.core.seq.call(null, b);
  if(cljs.core.truth_(c)) {
    for(var d = cljs.core.first.call(null, c);;) {
      if(a.addChild(d, !0), d = cljs.core.next.call(null, c), cljs.core.truth_(d)) {
...
de.karolski.teeter_totter.core._PLUS_control_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'text"], {"\ufdd0'text":cljs.core.Vector.fromArray([function(a) {
  return a.getCaption
}, function(a, b) {
  return a.setCaption(b)
}])}));
de.karolski.teeter_totter.core._PLUS_button_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'text", "\ufdd0'tooltip", "\ufdd0'color", "\ufdd0'button-set"], {"\ufdd0'text":cljs.core.Vector.fromArray([function(a) {
  return a.getContent
}, function(a, b) {
  return a.setContent(b)
}]), "\ufdd0'tooltip":cljs.core.Vector.fromArray([function(a) {
  return a.getTooltip
}, function(a, b) {
  return a.setTooltip(b)
}]), "\ufdd0'color":cljs.core.Vector.fromArray([function(a) {
  return a.getValue
}, function(a, b) {
  return a.setValue(b)
}]), "\ufdd0'button-set":cljs.core.Vector.fromArray([function(a) {
  return a.getButtonSet
}, function(a, b) {
  return a.setButtonSet(b)
}])}));
de.karolski.teeter_totter.core._PLUS_dialog_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'title"], {"\ufdd0'title":cljs.core.Vector.fromArray([function(a) {
  return a.getTitle
}, function(a, b) {
  return a.setTitle(b)
}])}), cljs.core.ObjMap.fromObject(["\ufdd0'modal?"], {"\ufdd0'modal?":cljs.core.Vector.fromArray([function(a) {
  return a.getModal
}, function(a, b) {
  return a.setModal(b)
}])}), cljs.core.ObjMap.fromObject(["\ufdd0'content"], {"\ufdd0'content":cljs.core.Vector.fromArray([function(a) {
  return a.getChildAt(0)
}, function(a, b) {
  return a.addChildAt(b, 0, !0)
}])}));
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurable$ = !0;
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurable$_config = function(a, b) {
  return cljs.core.get_in.call(null, de.karolski.teeter_totter.core.config_map.call(null, a), cljs.core.Vector.fromArray([b, 0])).call(null, a)
};
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurable$_config_BANG_ = function(a, b, c) {
  return cljs.core.get_in.call(null, de.karolski.teeter_totter.core.config_map.call(null, a), cljs.core.Vector.fromArray([b, 1])).call(null, a, c)
};
goog.ui.Button.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
goog.ui.Button.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map = function() {
  return de.karolski.teeter_totter.core._PLUS_button_opt_map_PLUS_
};
goog.ui.Dialog.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
goog.ui.Dialog.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map = function() {
  return de.karolski.teeter_totter.core._PLUS_dialog_opt_map_PLUS_
};
goog.ui.Control.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
goog.ui.Control.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map = function() {
  return de.karolski.teeter_totter.core._PLUS_control_opt_map_PLUS_
};
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurableMap$ = !0;
goog.ui.Component.prototype.de$karolski$teeter_totter$core$AConfigurableMap$_config_map = function() {
  return de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_
};
de.karolski.teeter_totter.core.dialog = function() {
  var a = function(a) {
    var a = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, b = cljs.core.get.call(null, a, "\ufdd0'on-select");
    cljs.core.get.call(null, a, "\ufdd0'button-set");
    cljs.core.get.call(null, a, "\ufdd0'title");
    cljs.core.get.call(null, a, "\ufdd0'content");
    var e = new goog.ui.Dialog;
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, e, a);
    cljs.core.truth_(b) && goog.events.listen.call(null, e, goog.ui.Dialog.EventType.SELECT, b);
    return e
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
...
de.karolski.teeter_totter.core.button = function() {
  var a = function(a) {
    var a = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, b = cljs.core.get.call(null, a, "\ufdd0'color");
    cljs.core.get.call(null, a, "\ufdd0'tooltip");
    var e = cljs.core.get.call(null, a, "\ufdd0'text", ""), b = cljs.core.truth_(b) ? new goog.ui.ColorButton(e) : new goog.ui.Button(e);
...
de.karolski.teeter_totter.core.text = function() {
  var a = function(a) {
    var a = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, b = cljs.core.get.call(null, a, "\ufdd0'text", ""), b = new goog.ui.LabelInput(b);
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, b, a);
    return b
  }, b = function(b) {
    var d = null;
...
de.karolski.teeter_totter.core.label = function() {
  var a = function(a) {
    ...
    cljs.core.get.call(null, a, "\ufdd0'text");
    var b = new goog.ui.Control;
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, b, a);
    return b
  }, b = function(b) {
    var d = null;
...
de.karolski.teeter_totter.core.panel = function() {
  var a = function(a) {
    var b = cljs.core.truth_(cljs.core.seq_QMARK_.call(null, a)) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, e = cljs.core.get.call(null, b, "\ufdd0'items"), f = cljs.core.get.call(null, b, "\ufdd0'orientation", "\ufdd0'horizontal"), a = new goog.ui.Component;
    de.karolski.teeter_totter.core.generic_configure_BANG_.call(null, a, b);
    if(cljs.core.truth_(cljs.core.truth_(e) ? cljs.core._EQ_.call(null, f, "\ufdd0'horizontal") : e)) {
      if(e = cljs.core.seq.call(null, e), cljs.core.truth_(e)) {
        for(b = cljs.core.first.call(null, e);;) {
          if(goog.style.setInlineBlock.call(null, b.getElement()), b = cljs.core.next.call(null, e), cljs.core.truth_(b)) {
      ...
      if(e = cljs.core.seq.call(null, e), cljs.core.truth_(e)) {
        for(b = cljs.core.first.call(null, e);;) {
          if(goog.style.setStyle.call(null, b.getElement(), "display", "block"), b = cljs.core.next.call(null, e), cljs.core.truth_(b)) {
            e = b, b = cljs.core.first.call(null, e)
          }else {
            break
          }
...
de.karolski.teeter_totter.core.main = function() {
  ...
  de.karolski.teeter_totter.core.dialog.call(null, "\ufdd0'title", "Hello There!", "\ufdd0'content", de.karolski.teeter_totter.core.vertical_panel.call(null, "\ufdd0'items", cljs.core.Vector.fromArray([de.karolski.teeter_totter.core.horizontal_panel.call(null, "\ufdd0'items", cljs.core.Vector.fromArray([de.karolski.teeter_totter.core.label.call(null, "\ufdd0'text", "Name"), de.karolski.teeter_totter.core.text.call(null, "\ufdd0'text", "Joe Smith")])), de.karolski.teeter_totter.core.horizontal_panel.call(null, 
  "\ufdd0'items", cljs.core.Vector.fromArray([de.karolski.teeter_totter.core.label.call(null, "\ufdd0'text", "E-Mail"), de.karolski.teeter_totter.core.text.call(null, "\ufdd0'text", "Joe.Smith@template.com")])), de.karolski.teeter_totter.core.horizontal_panel.call(null, "\ufdd0'items", cljs.core.Vector.fromArray([de.karolski.teeter_totter.core.button.call(null, "\ufdd0'text", "Push me!", "\ufdd0'tooltip", "Not implemented", "\ufdd0'color", "green", "\ufdd0'listen", cljs.core.Vector.fromArray(["\ufdd0'action", 
  function() {
    return de.karolski.teeter_totter.core.debug.call(null, "Button clicked!")
  }]))]))]))).setVisible(!0);
  goog.debug.Logger.getLogger.call(null, "Local").info("Hallo Welt! Ich war hier!");
...
goog.exportSymbol("de.karolski.teeter_totter.core.main", de.karolski.teeter_totter.core.main);
