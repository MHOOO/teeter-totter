...
de.karolski.teeter_totter.core.event_kw__GT_google_event = function(a) {
  ...
  "\ufdd0'disable":goog.ui.Component.EventType.DISABLE, "\ufdd0'unselect":goog.ui.Component.EventType.UNSELECT, "\ufdd0'unhighlight":goog.ui.Component.EventType.UNHIGHLIGHT, "\ufdd0'open":goog.ui.Component.EventType.OPEN, "\ufdd0'deactivate":goog.ui.Component.EventType.DEACTIVATE, "\ufdd0'select":goog.ui.Component.EventType.SELECT, "\ufdd0'show":goog.ui.Component.EventType.SHOW, "\ufdd0'activate":goog.ui.Component.EventType.ACTIVATE}))
};
de.karolski.teeter_totter.core.listen = function() {
  var a = null, b = function() {
    ...
    goog.events.listen(a, de.karolski.teeter_totter.core.event_kw__GT_google_event.call(null, b), c);
    return a
  }, a = function(a, e, f) {
    var g = f;
    switch(arguments.length) {
...
de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_ = cljs.core.ObjMap.fromObject(["\ufdd0'listen", "\ufdd0'visible?", "\ufdd0'items"], {"\ufdd0'listen":cljs.core.PersistentVector.fromArray([function() {
...
}], !0), "\ufdd0'items":cljs.core.PersistentVector.fromArray([function() {
  de.karolski.teeter_totter.core.debug.call(null, "NOT IMPLEMENTED!");
  return null
}, function(a, b) {
  var c = cljs.core.seq.call(null, b);
...
de.karolski.teeter_totter.core._PLUS_control_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'text"], {"\ufdd0'text":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getCaption()
}, function(a, b) {
  return a.setCaption(b)
}], !0)}));
de.karolski.teeter_totter.core._PLUS_button_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'text", "\ufdd0'tooltip", "\ufdd0'color", "\ufdd0'button-set"], {"\ufdd0'text":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getContent()
}, function(a, b) {
...
de.karolski.teeter_totter.core._PLUS_dialog_opt_map_PLUS_ = cljs.core.merge.call(null, de.karolski.teeter_totter.core._PLUS_component_opt_map_PLUS_, cljs.core.ObjMap.fromObject(["\ufdd0'title"], {"\ufdd0'title":cljs.core.PersistentVector.fromArray([function(a) {
  return a.getTitle()
}, function(a, b) {
  return a.setTitle(b)
...
de.karolski.teeter_totter.core.dialog = function() {
  var a = function(a) {
    ...
    cljs.core.truth_(b) && goog.events.listen(e, goog.ui.Dialog.EventType.SELECT, b);
    return e
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
...
de.karolski.teeter_totter.core.button = function() {
  var a = function(a) {
    ...
    var e = cljs.core._lookup.call(null, a, "\ufdd0'text", ""), b = cljs.core.truth_(b) ? new goog.ui.ColorButton(e) : new goog.ui.Button(e);
...
de.karolski.teeter_totter.core.panel = function() {
  var a = function(a) {
    var b = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a, e = cljs.core._lookup.call(null, b, "\ufdd0'items", null), f = cljs.core._lookup.call(null, b, "\ufdd0'orientation", "\ufdd0'horizontal"), a = new goog.ui.Component;
    ...
    if(cljs.core.truth_(cljs.core.truth_(e) ? cljs.core._EQ_.call(null, f, "\ufdd0'horizontal") : e)) {
      if(e = cljs.core.seq.call(null, e)) {
        for(b = cljs.core.first.call(null, e);;) {
          if(goog.style.setInlineBlock(b.getElement()), b = cljs.core.next.call(null, e)) {
      ...
      if(e = cljs.core.seq.call(null, e)) {
        for(b = cljs.core.first.call(null, e);;) {
          if(goog.style.setStyle(b.getElement(), "display", "block"), b = cljs.core.next.call(null, e)) {
            e = b, b = cljs.core.first.call(null, e)
          }else {
            break
          }
